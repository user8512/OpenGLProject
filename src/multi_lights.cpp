...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        */
        ...
        lightingShader.setVec3("pointLights[0].ambient", 0.09f, 0.03f, 0.03f);
        lightingShader.setVec3("pointLights[0].diffuse", 0.45f, 0.3f, 0.3f);
        lightingShader.setVec3("pointLights[0].specular", 0.6f, 0.4f, 0.4f);
        ...
        lightingShader.setVec3("pointLights[1].diffuse", 0.3f, 0.3f, 0.3f);
        ...
        for (unsigned int i = 0; i < 10; i++)
        {
            ...
            model = glm::rotate(model, glm::radians(float(glfwGetTime()) * 45.0f), glm::vec3(1.0f, 0.3f, 0.5f));
            lightingShader.setMat4("model", model);
